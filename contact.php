        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s"> -->
                    ...
                    } elseif (isset($_GET['status']) && $_GET['status'] == "email-available") {
                        echo "<div class='alert alert-primary' role='alert'>Email Sudah Ada</div>";
                    }
                    ?>
                    ...
                    <form method="POST" action="contact-controller/insert-contact.php">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input required="text" class="form-control" name="subject" id="subject" placeholder="Subject">
                                    <label for="subject">Subject</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea name="message" required="message" class="form-control" placeholder="Leave a message here" id="message" style="height: 150px"></textarea>
