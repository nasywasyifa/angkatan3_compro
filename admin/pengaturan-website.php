                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="website_name" placeholder="Masukan nama website"
                                                            required
                                                            value="<?php echo isset($rowPengaturan['website_name']) ? $rowPengaturan['website_name'] : '' ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="" class="form-label">Telepon</label>
                                                        <input type="text" class="form-control" name="website_phone" placeholder="Masukan telp website"
                                                            required
                                            ...
                                            <div class="mb-3">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="website_address" placeholder="Masukan alamat anda"
                                                        required
